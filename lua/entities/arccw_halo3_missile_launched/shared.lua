...
ENT.FuseTime = 16
ENT.ArmTime = 0.35
ENT.TrackingAngle = 0.8

AddCSLuaFile()

function ENT:Initialize()
    if SERVER then
	util.SpriteTrail( self, 0, Color(255,255,255,155), false, 15, 0, 1.25, 1, "trails/smoke" )
	...
	sound.Play( "halo/halo_3/missile_fire" .. math.random(1,4) .. ".ogg",  self:GetPos(), 100, 100 )
        self.kt = CurTime() + self.FuseTime
        self.motorsound = CreateSound( self, "halo/halo_3/missile_loop.wav")
    end
