...
self.flightvector = self.Entity:GetForward() * ((100*10.5)/50)
self.timeleft = CurTime() + 900
self.Owner = self:GetOwner()
self.Entity:SetModel( "models/snowysnowtime/projectiles/needler_projectile.mdl" )
...
Glow:SetKeyValue("rendercolor","190 0 190")
	...
	local tr = util.TraceLine( trace )
		...
		if tr.Hit then
				local effectdata = EffectData()
					...
					util.Effect( "hce_pistol_impact", effectdata )
					util.BlastDamage(self.Entity, self:OwnerGet(), tr.HitPos, 20, 15)
