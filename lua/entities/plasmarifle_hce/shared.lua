...
util.SpriteTrail(self, 0, Color(255,255,255,255), false, 4.5, 0, 0.1, 0.01, "snowysnowtime/contrails/plasmarifle_contrail.vmt");     
...
Glow:SetKeyValue("model","effects/halo_ce/flare_pr_overcharge.vmt")
