...
SWEP.ViewModel = "models/snowysnowtime/eonace/c_hum_spiker.mdl"
SWEP.WorldModel = "models/snowysnowtime/eonace/w_spiker.mdl"
...
SWEP.MuzzleVelocity = 76.2 -- projectile or phys bullet muzzle velocity
-- IN M/S

SWEP.TracerNum = 1 -- tracer every X
SWEP.Tracer = "effect_astw2_halo3_tracer_spiker" -- tracer every X
...
SWEP.ShootSound = "h3.spiker_fire"
