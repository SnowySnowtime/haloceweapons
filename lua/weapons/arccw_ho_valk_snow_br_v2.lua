...
SWEP.TrueName = "BR55"
SWEP.Trivia_Class = "Battle Rifle | Halo Online Variant Pack 2" -- it would actually be preferrable not having to make this a separate weapon, but arccw has forced my hand. im going to fucking sleep, have fun.
...
SWEP.ViewModel = "models/snowysnowtime/ho/c_br_p2.mdl"
SWEP.WorldModel = "models/snowysnowtime/ho/c_br_p2.mdl"
...
SWEP.AttachmentElements = {
	["acc2"] = {
		...
		AttPosMods = {
             [1] = {
                vpos = Vector(5.3, 0, 7.85), -- offset that the attachment will be relative to the bone
				vang = Angle(0, 0, 0),
	...
	["mag2"] = {
		...
		AttPosMods = {
             [1] = {
                vpos = Vector(5.3, 0, 7.43), -- offset that the attachment will be relative to the bone
				vang = Angle(0, 0, 0),
				wpos = Vector(8, 1.3, -7.55),
				wang = Angle(-12, -1.155, 175)
				},
	...
	["rof2"] = {
		...
		AttPosMods = {
             [1] = {
                vpos = Vector(5.0, 0, 7.8), -- offset that the attachment will be relative to the bone
				vang = Angle(0, 0, 0),
				wpos = Vector(8, 1.3, -7.55),
				wang = Angle(-12, -1.155, 175)
				},
	...
	["rng2"] = {
		...
		AttPosMods = {
             [1] = {
                vpos = Vector(5.35, 0, 7.55), -- offset that the attachment will be relative to the bone
				vang = Angle(0, 0, 0),
				wpos = Vector(8, 1.3, -7.55),
				wang = Angle(-12, -1.155, 175)
				},
...
SWEP.Attachments = {
	{
        ...
        Offset = {
            vpos = Vector(5.4, 0, 7.8), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
            wpos = Vector(8, 1.3, -7.55),
            wang = Angle(-12, -1.155, 175)
        },
	...
	{
        PrintName = "Variant",
        Slot = {"variant_brho2","variant_brhou"},
...
SWEP.Hook_GetShootSound = function(wep, sound)
	local brtype = {
		["h3_bronline_alt"] = "br_fire3",
		["h3_bronline_alt_2"] = "br_fire4",
		["h3_bronline_alt_3"] = "br_fire8",
		["h3_bronline_alt_4"] = "br_fire5",
		["h3_bronline_alt_5"] = "br_fire6",
	}
