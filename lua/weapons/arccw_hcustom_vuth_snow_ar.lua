...
SWEP.PrintName = "Proto-Assault Rifle"
SWEP.TrueName = "MA5B"
SWEP.Trivia_Class = "Pre-Xbox Assault Rifle"
...
SWEP.ViewModel = "models/snowysnowtime/vuthakral/c_fp_prexb_ar.mdl"
...
SWEP.ActivePos = Vector(-0.25, 1, 1.5)
...
SWEP.CustomizePos = Vector(3.824, -2, -1)
