...
SWEP.PrintName = "Assault Rifle Obrez"
SWEP.TrueName = "MA5C_XO- ICWS"
SWEP.Trivia_Class = "Assault Rifle"
SWEP.Trivia_Desc = "Experimental shortened version of the MA5C."
SWEP.Trivia_Manufacturer = "Misriah Armory"
SWEP.Trivia_Calibre = "7.0x43mm XPE HP"
SWEP.Trivia_Mechanism = "Automatic"
SWEP.Trivia_Country = "Obama"
...
SWEP.ViewModel = "models/snowysnowtime/vuthakral/fesiug/c_hum_ma5co_4.mdl"
...
SWEP.Delay = 60 / 650 * 0.8 -- 60 / RPM.
SWEP.Num = 1 -- number of shots per trigger pull.
SWEP.Firemodes = {
    {
        Mode = -4,
		PostBurstDelay = 60/650,
		RunawayBurst = true,
		AutoBurst = true,
    },
    {
