att.PrintName = "Beam Rifle Scope"
att.Icon = Material("entities/tfa_hce_snow_objectiveflag.png")
att.Description = "A powerful 10x HUD-linked scope for the Type-50 Beam Rifle."
...
local ScopeTexture	= Material("hud/scopes/beam_rifle_scope")
local proscopesize		= 475
