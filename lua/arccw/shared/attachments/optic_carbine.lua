att.PrintName = "2D Carbine Scope"
att.Icon = Material("entities/tfa_hce_snow_objectiveflag.png")
att.Description = "A HUD-linked 2x scope for the Covenant Carbine"
...
att.Desc_Cons = {
	"Only available for the Type-51 Carbine",
}
att.AutoStats = true
att.Ignore = false
att.Slot = "carbinescope"
...
att.ExcludeElements = {"rail"}

local ScopeTexture	= Material("hud/scopes/carbine_scope")
local proscopesize		= 270
