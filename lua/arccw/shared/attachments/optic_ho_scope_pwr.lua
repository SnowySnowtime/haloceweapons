att.PrintName = "BR Power Scope"
att.Icon = Material("entities/tfa_hce_snow_objectiveflag.png")
att.Description = "A Powerful 2.5x Scope built for the BR55HB SR for precision aiming. Best used with Semi-Auto weaponry."
...
att.Model = "models/snowysnowtime/valk/ho/pwr_scope.mdl"
